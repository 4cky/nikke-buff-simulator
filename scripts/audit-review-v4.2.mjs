...
const EXPECTED_PARSER='4.2.0';
const JSON_OUTPUT='review-audit-v4.2.json';
const MARKDOWN_OUTPUT='review-audit-v4.2.md';
...
export async function auditReview(){
  ...
  const md=['# Review Audit — parser v4.2.0','',`Generated: ${report.generated_at}`,'',
